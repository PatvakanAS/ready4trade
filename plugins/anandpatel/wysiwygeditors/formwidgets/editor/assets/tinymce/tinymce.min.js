...
!function (e, t) {
    ...
    var s = {}, l = "tinymce/geom/Rect", c = "tinymce/util/Promise", u = "tinymce/util/Delay", d = "tinymce/Env",
        ...
        k = "tinymce/caret/CaretContainer", R = "tinymce/dom/RangeUtils", T = "tinymce/NodeChange",
        A = "tinymce/html/Node", B = "tinymce/html/Schema", D = "tinymce/html/SaxParser", L = "tinymce/html/DomParser",
        M = "tinymce/html/Writer", P = "tinymce/html/Serializer", H = "tinymce/dom/Serializer",
        ...
        ke = "tinymce/ui/FloatPanel", Re = "tinymce/ui/Window", Te = "tinymce/ui/MessageBox",
        Ae = "tinymce/WindowManager", Be = "tinymce/ui/Tooltip", De = "tinymce/ui/Widget", Le = "tinymce/ui/Progress",
        Me = "tinymce/ui/Notification", Pe = "tinymce/NotificationManager", He = "tinymce/dom/NodePath",
        Oe = "tinymce/util/Quirks", Ie = "tinymce/EditorObservable", Fe = "tinymce/Mode", ze = "tinymce/Shortcuts",
        ...
        Ge = "tinymce/caret/LineUtils", Je = "tinymce/DragDropOverrides", Qe = "tinymce/SelectionOverrides",
        Ze = "tinymce/util/Uuid", et = "tinymce/Editor", tt = "tinymce/util/I18n", nt = "tinymce/FocusManager",
        rt = "tinymce/EditorManager", it = "tinymce/LegacyInput", ot = "tinymce/util/XHR", at = "tinymce/util/JSON",
        st = "tinymce/util/JSONRequest", lt = "tinymce/util/JSONP", ct = "tinymce/util/LocalStorage",
        ut = "tinymce/Compat", dt = "tinymce/ui/Layout", ft = "tinymce/ui/AbsoluteLayout", ht = "tinymce/ui/Button",
        pt = "tinymce/ui/ButtonGroup", mt = "tinymce/ui/Checkbox", gt = "tinymce/ui/ComboBox",
        vt = "tinymce/ui/ColorBox", yt = "tinymce/ui/PanelButton", bt = "tinymce/ui/ColorButton",
        Ct = "tinymce/util/Color", xt = "tinymce/ui/ColorPicker", wt = "tinymce/ui/Path", Nt = "tinymce/ui/ElementPath",
        Et = "tinymce/ui/FormItem", _t = "tinymce/ui/Form", St = "tinymce/ui/FieldSet", kt = "tinymce/ui/FilePicker",
        Rt = "tinymce/ui/FitLayout", Tt = "tinymce/ui/FlexLayout", At = "tinymce/ui/FlowLayout",
        Bt = "tinymce/ui/FormatControls", Dt = "tinymce/ui/GridLayout", Lt = "tinymce/ui/Iframe",
        Mt = "tinymce/ui/InfoBox", Pt = "tinymce/ui/Label", Ht = "tinymce/ui/Toolbar", Ot = "tinymce/ui/MenuBar",
        It = "tinymce/ui/MenuButton", Ft = "tinymce/ui/MenuItem", zt = "tinymce/ui/Throbber", Ut = "tinymce/ui/Menu",
        Wt = "tinymce/ui/ListBox", Vt = "tinymce/ui/Radio", $t = "tinymce/ui/ResizeHandle", qt = "tinymce/ui/SelectBox",
        jt = "tinymce/ui/Slider", Yt = "tinymce/ui/Spacer", Xt = "tinymce/ui/SplitButton",
        Kt = "tinymce/ui/StackLayout", Gt = "tinymce/ui/TabPanel", Jt = "tinymce/ui/TextBox", Qt = "tinymce/Register";
    r(l, [], function () {
        function e(e, t, n) {
            var r, i, a, s, l, u;
        ...
        function b(t, n) {
            var i = n.length > 0, o = t.length > 0, a = function (r, a, s, l, c) {
                var u, d, f, h = 0, p = "0", m = r && [], v = [], y = R, b = r || o && w.find.TAG("*", c),
        ...
        var C, x, w, N, E, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F = "sizzle" + -new Date, z = window.document,
        ...
        var w = document, N = Array.prototype.push, E = Array.prototype.slice,
            _ = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, S = e.Event, k,
            R = r.makeMap("children,contents,next,prev"),
        ...
        function t(n) {
            ...
            var M = this, P = n.doc, H = 0, O = 1, I = 2, F = !0, z = !1, U = "startOffset", W = "startContainer",
        ...
        return function (e) {
            ...
            var v = this, y = {}, b = {}, C = [], x, w, N, E, _, S, k, R, T, A, B, D, L, M = {}, P = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, C, x, w, N, E, _, S, k, R, T, A, B, D, L, M, P,
                    H, O, I, F = 0, z = t.decode, U, W = n.makeMap("src,href,data,background,formaction,poster"),
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate" in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, C, x, w, N, E, _, S, k, R, T, A = [], B, D, L, M, P, H, O, I;
                if (o = o || {}, h = {}, p = {}, R = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), H = l.children, k = r.validate, I = "forced_root_block" in o ? o.forced_root_block : r.forced_root_block, P = l.getWhiteSpaceElements(), T = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, L = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({
                    ...
                    start: function (e, t, n) {
                        ...
                        if (r = k ? l.getElementRule(t) : {}) {
                            if (R[t] && !B) {
                                if (n = b.firstChild, n && 3 === n.type) if (i = n.value.replace(T, ""), i.length > 0) n.value = i, n = n.next; else for (o = n.next, n.remove(), n = o; n && 3 === n.type;) i = n.value, o = n.next, (0 === i.length || M.test(i)) && (n.remove(), n = o), n = o;
                            ...
                            if (B && P[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O)) if (r.paddEmpty) b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id) return a = b.parent, R[b.name] ? b.empty().remove() : b.unwrap(), void (b = a);
                            b = b.parent
                        }
                    }
        ...
        return function (i, a) {
            ...
            function u(e, t, n) {
                var i, o, u, f, h;
                d(), b(), i = N.getPos(e, j), L = i.x, M = i.y, h = e.getBoundingClientRect(), o = h.width || h.right - h.left, u = h.height || h.bottom - h.top, _ != e && (y(), _ = e, F = z = 0), f = a.fire("ObjectSelected", {target: e}), s(e) && !f.isDefaultPrevented() ? E(R, function (e, i) {
                    function a(t) {
            ...
            function m(e) {
                ...
                for (r in R) if (i = R[r], o = t.offsetWidth * i[0], s = t.offsetHeight * i[1], $(o - l) < 8 && $(s - c) < 8) {
                    T = i;
                    break
                }
            ...
            var N = a.dom, E = t.each, _, S, k, R, T, A, B, D, L, M, P, H, O, I, F, z, U = a.getDoc(), W = document,
                V = r.ie && r.ie < 11, $ = Math.abs, q = Math.round, j = a.getBody(), Y, X;
            R = {nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]};
            ...
            function o(o) {
                ...
                if (T = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(T), D = T.startContainer, L = T.startOffset, W = (l.force_p_newlines ? "p" : "") || l.forced_root_block, W = W ? W.toUpperCase() : "", P = a.doc.documentMode, H = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (V = L > D.childNodes.length - 1, D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D, L = V && 3 == D.nodeType ? D.nodeValue.length : 0), B = S(D)) {
                        ...
                        W && M === i.getBody() || (W = W || "P", x() ? R() : x(!0) ? (O = M.parentNode.insertBefore(C(), M), m(O), v(M)) : (A = T.cloneRange(), A.setEndAfter(M), I = A.extractContents(), _(I), O = I.firstChild, a.insertAfter(I, M), g(O), k(M), a.isEmpty(M) && b(M), O.normalize(), a.isEmpty(O) ? (a.remove(O), R()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {newBlock: O}), c.add())
                    }
                }
            }
        ...
        var l = a.matchNodeNames("td th"), c = function (a, c, u) {
            ...
            function y(t) {
                ...
                if (t) {
                    ...
                    S = L.createRng(), k = t.previousSibling, k && 3 == k.nodeType ? (S.setStart(k, k.nodeValue.length), e.ie || (R = t.nextSibling, R && 3 == R.nodeType && (k.appendData(R.data), R.parentNode.removeChild(R)))) : (S.setStartBefore(t), S.setEndBefore(t)), c = L.getParent(t, L.isBlock), L.remove(t), c && L.isEmpty(c) && (a.$(c).empty(), S.setStart(c, 0), S.setEnd(c, 0), l(c) || g(c) || !(u = o(S)) ? L.add(c, L.create("br", {"data-mce-bogus": "1"})) : (S = u, L.remove(c))), D.setRng(S)
                }
            }

            var b, C, x, w, N, E, _, S, k, R, T, A, B = a.schema.getTextInlineElements(), D = a.selection, L = a.dom;
            /^ | $/.test(c) && (c = d(c)), b = a.parser, A = u.merge, C = new n({validate: a.settings.validate}, a.schema), T = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', E = {
                content: c,
                format: "html",
                selection: !0
        ...
        return function (n) {
            ...
            var R, T, A, B = {state: {}, exec: {}, value: {}}, D = n.settings, L;
            n.on("PreInit", function () {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    var e = T.getBookmark();
                    n.setContent(n.getContent({cleanup: f}), {cleanup: f}), T.moveToBookmark(e)
                    ...
                    n.execCommand("mceInsertContent", !1, r.replace(/\{\$selection\}/g, T.getContent({format: "text"})))
                }, mceInsertLink: function (e, t, n) {
                    var r;
                    "string" == typeof n && (n = {href: n}), r = R.getParent(T.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || A.remove("link"), n.href && A.apply("link", n, r)
                }, selectAll: function () {
                    var e = R.getRoot(), t;
                    ...
                    var v = R.getParent(m, R.isBlock), y = v ? v.nodeName.toUpperCase() : "",
                        b = v ? R.getParent(v.parentNode, R.isBlock) : null, C = b ? b.nodeName.toUpperCase() : "",
                        x = s && s.ctrlKey;
        ...
        function y(c) {
            ...
            function Y() {
                ...
                var g = b(I, 1, ne, E), v = b(I, -1, re, N), w = b(j, 1, E, N), _ = b(j, -1, N, E),
                    R = b(F, -1, a.upUntil), B = b(F, 1, a.downUntil);
            ...
            var ee = c.getBody(), te = new t(ee), ne = b(v, te.next), re = b(v, te.prev), ie = new o(c.getBody(), y),
                oe = "sel-" + c.dom.uniqueId(), ae, se = c.$;
        ...
        var D = e.DOM, L = r.ThemeManager, M = r.PluginManager, P = N.extend, H = N.each, O = N.explode, I = N.inArray,
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v = [], y, b, C, x, w, N, E, _, S, k, R, T, A, B, D,
                    L, M, P, H, O, I, F, z = Math.max, U = Math.min;
        ...
        function a(e) {
            ...
            function i() {
                ...
                var r = 0, i = [], o = [{
                    title: "Headings", items: [{title: "Heading 1", format: "h1"}, {title: "Heading 2", format: "h2"}, {
                        title: "Heading 3",
                        format: "h3"
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, N, E = [], _ = [], S, k, R, T, A,
                    B;
